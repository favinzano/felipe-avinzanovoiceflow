...
> Excepción 1.1.11: el propietario autorizó el lanzamiento público `latest` antes de cerrar esta matriz y asumió los riesgos pendientes. La autorización auditable está en `docs/legal-release-approval.json` y no se hereda a otra versión.
