...
Estado al 17 de julio de 2026: **EXCEPCIÓN TEMPORAL DEL PROPIETARIO PARA 1.1.11**.

Felipe Avinzano autorizó expresamente continuar con el merge y publicar `latest` para la versión 1.1.11, asumiendo la responsabilidad por los requisitos externos aún pendientes y por los artefactos sin firma. La excepción está registrada en `docs/legal-release-approval.json`, se limita a 1.1.11 y no constituye aprobación jurídica ni cierre de los puntos siguientes.
