...
> Excepción 1.1.9: Felipe Avinzano autorizó publicar esta versión como `latest` aun con artefactos sin firma y asumió expresamente ese riesgo. La excepción queda limitada a 1.1.9 en `docs/legal-release-approval.json`; las reglas de firma siguientes continúan vigentes para versiones posteriores.
