...
assert.ok(packageJson.build.win.extraResources[0].filter.includes(brand.helperExecutable));
assert.ok(packageJson.build.win.extraResources[0].filter.includes('whisper-cli.exe'));
