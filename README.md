...
Para usuarios finales, utiliza el instalador versionado `felipe-avinzanovoiceflow-Setup-1.1.7-x64.exe`.
...
La versión `1.1.7` es la versión actual para Windows x64. Consulta `PRODUCTION_READINESS.md` y `docs/RELEASE_CHECKLIST.md` antes de publicar un instalador.
